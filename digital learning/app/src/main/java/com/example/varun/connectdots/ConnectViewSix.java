...
public class ConnectViewSix extends View {
    ...
    public ConnectViewSix(Context context) {
        super(context);
        mCanvas = new Canvas();
        mPath = new Path();
        mPaint = new Paint();
        ...
        Point p1 = new Point(140,400);//0
        Point p2 = new Point(50,400);//1
        Point p3 = new Point(50,300);//2
        Point p4 = new Point(200,300);//3
        Point p5 = new Point(250,200);//4
        Point p6 = new Point(410,200);//5
        Point p7 = new Point(460,300);//6
        Point p8 = new Point(550,300);//7
        Point p9 = new Point(550,400);//8
        Point p10 = new Point(520,400);//9
        //Point p11 = new Point(420,380);//10
        mPoints.add(p1);
        mPoints.add(p2);
        mPoints.add(p3);
        mPoints.add(p4);
    ...
    public ConnectViewSix(Context context, AttributeSet attrs) {
        super(context, attrs);
        mCanvas = new Canvas();
        mPath = new Path();
        mPaint = new Paint();
    ...
    public ConnectViewSix(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(460,400,50,mPaint);

        canvas.drawLine(250,400,410,400,mPaint);
        canvas.drawLine(210,300,450,300,mPaint);
        canvas.drawLine(250,200,250,300,mPaint);
