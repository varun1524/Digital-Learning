...
public class ConnectViewTwo extends View {
    ...
    public ConnectViewTwo(Context context) {
        super(context);
        mCanvas = new Canvas();
        mPath = new Path();
        mPaint = new Paint();
        ...
        Point p2 = new Point(130,300);//1
        Point p3 = new Point(330,100);//2
        Point p4 = new Point(530,300);//3
        Point p5 = new Point(330,490);//4
        Point p6 = new Point(330,110);//5
    ...
    public ConnectViewTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        mCanvas = new Canvas();
        mPath = new Path();
        mPaint = new Paint();
    ...
    public ConnectViewTwo(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        oval=new RectF();
        oval.set(60,270,600,480);
        canvas.drawArc(oval,225,90,false,mPaint);
        canvas.drawLine(330,505,270,600,mPaint);
        canvas.drawLine(330,505,390,600,mPaint);
        canvas.drawLine(270,600,390,600,mPaint);
