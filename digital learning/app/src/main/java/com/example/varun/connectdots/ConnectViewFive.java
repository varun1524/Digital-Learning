...
public class ConnectViewFive extends View {
    ...
    public ConnectViewFive(Context context) {
        super(context);
        mCanvas = new Canvas();
        mPath = new Path();
        mPaint = new Paint();
        ...
        Point p1 = new Point(330,50);//0
        Point p2 = new Point(420,250);//1
        Point p3 = new Point(610,250);//2
        Point p4 = new Point(450,380);//3
        Point p5 = new Point(560,550);//4
        Point p6 = new Point(330,450);//5
        Point p7 = new Point(100,550);//6
        Point p8 = new Point(210,380);//7
        Point p9 = new Point(50,250);//8
        Point p10 = new Point(240,250);//9
        Point p11 = new Point(320,50);//10
        mPoints.add(p1);
        mPoints.add(p2);
        mPoints.add(p3);
        mPoints.add(p4);
    ...
    public ConnectViewFive(Context context, AttributeSet attrs) {
        super(context, attrs);
        mCanvas = new Canvas();
        mPath = new Path();
        mPaint = new Paint();
    ...
    public ConnectViewFive (Context context, AttributeSet attrs, int defStyle) {
