...
public class ConnectViewOne extends View {
    ...
    public ConnectViewOne(Context context) {
        super(context);
        mCanvas = new Canvas();
        mPath = new Path();
        mPaint = new Paint();
    ...
    public ConnectViewOne(Context context, AttributeSet attrs) {
        super(context, attrs);
        mCanvas = new Canvas();
        mPath = new Path();
        mPaint = new Paint();
    ...
    public ConnectViewOne(Context context, AttributeSet attrs, int defStyle) {
